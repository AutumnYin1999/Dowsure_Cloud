...
export const KNOWLEDGE_BASE: BenefitItem[] = [
  // ────────────────────── 1. 必选基础包 ──────────────────────
  {
    ...
    category: "base",
    price: 28_888,
    summary: "服务商入驻必选：展示位 + AI 拓客启航版 + 提现券 + TermPay 账期金融",
    description:
      "一次开通即获得豆服云平台基础固定展示位、AI 智能拓客启航版（20 份数据分析报告）、100 万美金提现优惠券，以及面向终端卖家的 TermPay（豆分期升级版）账期金融服务能力。所有服务商均需开通此基础包。",
    keywords: [
      "基础包",
      "展示位",
      "AI 拓客",
  ...
  // ────────────────────── 3. 增值服务 ──────────────────────
  {
    ...
    price: 20_000,
    summary: "在自有官网 / ERP / 客户后台 / 公众号中嵌入 TermPay 账期金融入口",
    description:
      "服务商可在自有官网、ERP、客户后台或公众号中嵌入 TermPay（豆分期升级版）账期金融入口，把客户的物流、海外仓、广告、采购等大额账单一键导入 TermPay 流程；卖家完成签约后由资金方放款至服务商账户。Dowsure 仅提供技术、数据与连接能力，资金与最终授信审批由银行/资金方承担。",
    keywords: [
      "嵌入式金融",
      "TermPay",
      "豆分期升级版",
  ...
  },
  {
    ...
    category: "value-added",
    price: 100_000,
    summary: "基于平台多维数据的账期风控模型，降低坏账与逾期风险",
    description:
      "接入 TermPay 账期风控引擎，为服务商客户提供账期评估、坏账预警与额度建议；常用于物流、海外仓、ERP 类服务商优化其垫资 / 账期业务。风控分析与额度建议由 Dowsure 技术与数据团队产出，资金方与银行依据自身策略做最终授信决定。",
    keywords: [
      "TermPay 风控",
      "账期风控",
      "坏账",
